            ...
            <main className="flex-grow">
              ...
              <div className="w-full relative z-10">
                ...
                <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
                  ...
                  <section className="w-full mx-auto flex flex-col md:flex-row gap-4 md:gap-8 mb-16">
                    ...
                    >
                      <p className="text-base leading-relaxed text-gray-600">
                        ...
                        aceitação legal e precisão por profissionais
                        certificados.
                      </p>
                    </Card>
                    ...
                    >
                      <p className="text-base leading-relaxed text-gray-600">
                        Traduções precisas e profissionais ideais para uso
                    ...
                    >
                      <p className="text-base leading-relaxed text-gray-600">
                        Tradução oficial certificada no Brasil com validade
                        legal para processos governamentais e acadêmicos.
                      </p>
                    </Card>
                  </section>
                  ...
                  <section className="w-full mx-auto flex flex-col md:flex-row gap-6 md:gap-10 justify-between items-stretch mb-16">
                    ...
                    <div className="w-full md:flex-1 flex flex-col gap-4 bg-white rounded-xl shadow-lg p-2 md:p-8 leading-relaxed text-gray-800">
                      ...
                      <p className="text-base md:text-lg font-medium text-gray-700 text-justify leading-relaxed">
                        ...
                        excepcional, assegurando precisão e confiabilidade em
                        cada projeto.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="w-full mx-auto flex flex-col md:flex-row gap-6 md:gap-10 justify-between text-center bg-white rounded-lg p-2 md:p-10 items-center box-border">
