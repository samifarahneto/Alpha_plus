      ...
      const unsubscribeFunctions = collections.map((collectionName) => {
        ...
        return onSnapshot(
          ...
          (snapshot) => {
            ...
            // Atualizar os projetos da tabela (apenas projetos pagos)
            if (
              collectionName === "b2bprojectspaid" ||
              collectionName === "b2cprojectspaid"
            ) {
              const paidProjects = snapshot.docs.map((doc) => ({
                id: doc.id,
                ...doc.data(),
              ...
              setProjects((prevProjects) => {
                ...
                return [...otherCollectionsProjects, ...paidProjects];
              });
            }
              ...
              <tbody className="table-body">
                {projects.map((project) => (
                  ...
                  >
                    ...
                    <td className="table-cell !py-1.5 whitespace-nowrap max-w-[120px] text-center">
                      <span className="status-badge status-approved">PAGO</span>
                    </td>
                    <td className="table-cell !py-1.5 whitespace-nowrap max-w-[120px] text-center">
